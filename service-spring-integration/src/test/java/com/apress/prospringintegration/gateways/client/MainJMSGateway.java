...
public class MainJMSGateway {
    public static void main(String[] args) throws Exception {
    	...
    	ClassPathXmlApplicationContext ctx =
                new ClassPathXmlApplicationContext( "/META-INF/spring/integration/pro-spring-integration/gateway-jms-service.xml","/META-INF/spring/integration/pro-spring-integration/common.xml");

        ClassPathXmlApplicationContext ctx1 =
                new ClassPathXmlApplicationContext("/META-INF/spring/integration/pro-spring-integration/gateway-jms-client.xml","/META-INF/spring/integration/pro-spring-integration/common.xml");
